...
IS
    ...
    BEGIN
      ...
      INTO p_emp_name
        ...
        AND fu.user_id = pptr.created_by
        AND primary_flag = 'Y'
    ...
    lv_item_key VARCHAR2(100) := 'INST-'|| p_sequence_no;
...
--                END;
                ...
                wf_engine.setitemattrtext(itemtype
                                        ,l_itemkey
                                        ,'ATTACHMENT_RN'
                                        ,'JSP:/OA_HTML/OA.jsp?OAFunc=XXUP_HR_PS_INST_ATTACHMENT_RNnull='
                                        || lv_seq_no
                                        );
                ...
                wf_engine.setitemattrtext(itemtype
                                        ,l_itemkey
                                        ,'#HISTORY'
                                        ,'JSP:/OA_HTML/OA.jsp?OAFunc=XXUP_HR_PS_INST_HIST_RNnull='
                                        || lv_seq_no
                                        );                        
