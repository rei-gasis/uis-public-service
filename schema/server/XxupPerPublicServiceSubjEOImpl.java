...
// ---------------------------------------------------------------------
public class XxupPerPublicServiceSubjEOImpl extends OAEntityImpl {
    public static final int SEQUENCENO = 0;
    public static final int LINENUMBER = 1;
    public static final int SELECTED = 2;
    public static final int SUBJECTAREAINTEREST = 3;
     ...
     */
    public XxupPerPublicServiceSubjEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.publicservice.schema.server.XxupPerPublicServiceSubjEO");
        }
