...
// ---------------------------------------------------------------------
public class XxupPerPSCountriesEOImpl extends OAEntityImpl {
     ...
     */
    public XxupPerPSCountriesEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.publicservice.schema.server.XxupPerPSCountriesEO");
        }
