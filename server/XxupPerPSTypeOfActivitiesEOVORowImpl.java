...
import xxup.oracle.apps.per.publicservice.schema.server.XxupPerPSTypeOfActivitiesEOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxupPerPSTypeOfActivitiesEOVORowImpl extends OAViewRowImpl {
    public static final int SEQUENCENO = 0;
    public static final int LINENUMBER = 1;
    public static final int TYPEOFACTIVITY = 2;
    ...
    public static final int TYPEOFACTIVITYDISPLAY = 14;

    /**This is the default constructor (do not remove)
     */
    public XxupPerPSTypeOfActivitiesEOVORowImpl() {
    }

    /**Gets XxupPerPSTypeOfActivitiesEO entity object.
     */
    public XxupPerPSTypeOfActivitiesEOImpl getXxupPerPSTypeOfActivitiesEO() {
        return (XxupPerPSTypeOfActivitiesEOImpl)getEntity(0);
    }
