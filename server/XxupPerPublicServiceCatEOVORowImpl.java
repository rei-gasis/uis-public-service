...
import xxup.oracle.apps.per.publicservice.schema.server.XxupPerPublicServiceCatEOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxupPerPublicServiceCatEOVORowImpl extends OAViewRowImpl {
    public static final int SEQUENCENO = 0;
    public static final int LINENUMBER = 1;
    public static final int OBJECTCATEGORY = 2;
     ...
     */
    public XxupPerPublicServiceCatEOVORowImpl() {
    }

    /**Gets XxupPerPublicServiceCatEO entity object.
     */
    public XxupPerPublicServiceCatEOImpl getXxupPerPublicServiceCatEO() {
        return (XxupPerPublicServiceCatEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for OBJECT_CATEGORY using the alias name ObjectCategory
     */
    public Number getObjectCategory() {
        return (Number) getAttributeInternal(OBJECTCATEGORY);
    }

    /**Sets <code>value</code> as attribute value for OBJECT_CATEGORY using the alias name ObjectCategory
     */
    public void setObjectCategory(Number value) {
        setAttributeInternal(OBJECTCATEGORY, value);
    }
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case LINENUMBER:
            ...
            return;
        case OBJECTCATEGORY:
            setObjectCategory((Number)value);
            return;
        case SPECIFICS:
