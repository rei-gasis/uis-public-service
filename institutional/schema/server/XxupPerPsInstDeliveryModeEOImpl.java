...
// ---------------------------------------------------------------------
public class XxupPerPsInstDeliveryModeEOImpl extends OAEntityImpl {
     ...
     */
    public XxupPerPsInstDeliveryModeEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.publicservice.institutional.schema.server.XxupPerPsInstDeliveryModeEO");
        }
    ...
    /**Gets the attribute value for DeliveryMode, using the alias name DeliveryMode
     */
    public String getDeliveryMode() {
        return (String)getAttributeInternal(DELIVERYMODE);
    }

    /**Sets <code>value</code> as the attribute value for DeliveryMode
     */
