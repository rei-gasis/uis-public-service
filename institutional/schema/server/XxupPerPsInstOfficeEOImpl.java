...
// ---------------------------------------------------------------------
public class XxupPerPsInstOfficeEOImpl extends OAEntityImpl {
     ...
     */
    public XxupPerPsInstOfficeEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.publicservice.institutional.schema.server.XxupPerPsInstOfficeEO");
        }
