...
// ---------------------------------------------------------------------
public class XxupPerPsInstSubjTrEOImpl extends OAEntityImpl {
     ...
     */
    public XxupPerPsInstSubjTrEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.publicservice.institutional.schema.server.tr.XxupPerPsInstSubjTrEO");
        }
    ...
    /**Gets the attribute value for SubjectAreaInterest, using the alias name SubjectAreaInterest
     */
    public String getSubjectAreaInterest() {
        return (String)getAttributeInternal(SUBJECTAREAINTEREST);
    }

    /**Sets <code>value</code> as the attribute value for SubjectAreaInterest
     */
