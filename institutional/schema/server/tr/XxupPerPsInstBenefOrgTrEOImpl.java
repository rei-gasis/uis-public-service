...
// ---------------------------------------------------------------------
public class XxupPerPsInstBenefOrgTrEOImpl extends OAEntityImpl {
     ...
     */
    public XxupPerPsInstBenefOrgTrEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.publicservice.institutional.schema.server.tr.XxupPerPsInstBenefOrgTrEO");
        }
