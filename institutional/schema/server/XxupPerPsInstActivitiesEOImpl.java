...
// ---------------------------------------------------------------------
public class XxupPerPsInstActivitiesEOImpl extends OAEntityImpl {
     ...
     */
    public XxupPerPsInstActivitiesEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.publicservice.institutional.schema.server.XxupPerPsInstActivitiesEO");
        }
    ...
    /**Sets <code>value</code> as the attribute value for Activity
     */
