...
import xxup.oracle.apps.per.publicservice.institutional.schema.server.XxupPerPsInstOfficeEOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxupPerPSInstOfficeEOVORowImpl extends OAViewRowImpl {
    public static final int SEQUENCENO = 0;
    public static final int LINENUMBER = 1;
    public static final int OFFICE = 2;
    public static final int TELNO = 3;
     ...
     */
    public XxupPerPSInstOfficeEOVORowImpl() {
    }

    /**Gets XxupPerPsInstOfficeEO entity object.
     */
    public XxupPerPsInstOfficeEOImpl getXxupPerPsInstOfficeEO() {
        return (XxupPerPsInstOfficeEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for TEL_NO using the alias name TelNo
     */
    public String getTelNo() {
        return (String) getAttributeInternal(TELNO);
    }

    /**Sets <code>value</code> as attribute value for TEL_NO using the alias name TelNo
     */
