...
import xxup.oracle.apps.per.publicservice.institutional.schema.server.XxupPerPsInstObjCatEOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxupPerPSInstObjCatEOVORowImpl extends OAViewRowImpl {
    public static final int SEQUENCENO = 0;
    public static final int LINENUMBER = 1;
    public static final int OBJECTIVECATEGORY = 2;
    public static final int SPECIFICS = 3;
     ...
     */
    public XxupPerPSInstObjCatEOVORowImpl() {
    }

    /**Gets XxupPerPsInstObjCatEO entity object.
     */
    public XxupPerPsInstObjCatEOImpl getXxupPerPsInstObjCatEO() {
        return (XxupPerPsInstObjCatEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for OBJECTIVE_CATEGORY using the alias name ObjectiveCategory
     */
    public String getObjectiveCategory() {
        return (String) getAttributeInternal(OBJECTIVECATEGORY);
    }

    /**Sets <code>value</code> as attribute value for OBJECTIVE_CATEGORY using the alias name ObjectiveCategory
     */
    public void setObjectiveCategory(String value) {
        setAttributeInternal(OBJECTIVECATEGORY, value);
    }

    /**Gets the attribute value for SPECIFICS using the alias name Specifics
     */
    public String getSpecifics() {
        return (String) getAttributeInternal(SPECIFICS);
    }

    /**Sets <code>value</code> as attribute value for SPECIFICS using the alias name Specifics
     */
    public void setSpecifics(String value) {
        setAttributeInternal(SPECIFICS, value);
    }
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case LINENUMBER:
            ...
            return;
        case OBJECTIVECATEGORY:
            setObjectiveCategory((String)value);
            return;
        case SPECIFICS:
            setSpecifics((String)value);
            return;
        case ATTRIBUTE1:
