...
import xxup.oracle.apps.per.publicservice.institutional.schema.server.XxupPerPsInstSubjEOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxupPerPSInstSubjEOVORowImpl extends OAViewRowImpl {
     ...
     */
    public XxupPerPSInstSubjEOVORowImpl() {
    }

    /**Gets XxupPerPsInstSubjEO entity object.
     */
    public XxupPerPsInstSubjEOImpl getXxupPerPsInstSubjEO() {
        return (XxupPerPsInstSubjEOImpl)getEntity(0);
    }
     ...
     */
    public String getSubjectAreaInterest() {
        return (String) getAttributeInternal(SUBJECTAREAINTEREST);
    }

    /**Sets <code>value</code> as attribute value for SUBJECT_AREA_INTEREST using the alias name SubjectAreaInterest
     */
    public void setSubjectAreaInterest(String value) {
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case LINENUMBER:
            ...
            return;
        case SUBJECTAREAINTEREST:
            setSubjectAreaInterest((String)value);
            return;
        case ATTRIBUTE1:
