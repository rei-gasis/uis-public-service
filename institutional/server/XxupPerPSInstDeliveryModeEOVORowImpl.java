...
import xxup.oracle.apps.per.publicservice.institutional.schema.server.XxupPerPsInstDeliveryModeEOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxupPerPSInstDeliveryModeEOVORowImpl extends OAViewRowImpl {
    public static final int SEQUENCENO = 0;
    public static final int LINENUMBER = 1;
    public static final int DELIVERYMODE = 2;
     ...
     */
    public XxupPerPSInstDeliveryModeEOVORowImpl() {
    }

    /**Gets XxupPerPsInstDeliveryModeEO entity object.
     */
    public XxupPerPsInstDeliveryModeEOImpl getXxupPerPsInstDeliveryModeEO() {
        return (XxupPerPsInstDeliveryModeEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for DELIVERY_MODE using the alias name DeliveryMode
     */
    public String getDeliveryMode() {
        return (String) getAttributeInternal(DELIVERYMODE);
    }

    /**Sets <code>value</code> as attribute value for DELIVERY_MODE using the alias name DeliveryMode
     */
    public void setDeliveryMode(String value) {
        setAttributeInternal(DELIVERYMODE, value);
    }
